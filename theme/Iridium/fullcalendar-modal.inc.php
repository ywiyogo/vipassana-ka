            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="save-event" method="POST">
                        ...
                        <div class="form-group">
                            <label>Vorträger/Veranstalter</label>
                            <input type="text" name="speaker" class="form-control" required/>
                        </div>
                        <div class="form-group">
                            <label>Ort</label>
                        ...
                        <div class="modal-footer">
                            <button type="button" id="delete-event" class="btn btn-danger pull-left" data-dismiss="modal">Löschen</button>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Abbrechen</button>
...
<div class="bootstrap-iso">
    <div class="modal fade" id="delete-event-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                ...
                <div class="modal-body">
                    <form name="delete-event" method="POST">
                        <div class="form-group">
                            <label>Titel</label>
                        ...
                        <div class="form-group">
                            <label>Vorträger/Veranstalter</label>
                            <input type="text" name="speaker" class="form-control" disabled/>
                        </div>
                        <div class="form-group">
                            <label>Ort</label>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <label>Begin</label>
                                <input type="text" name="evtStart" class="form-control col-xs-3"  disabled/>
                            </div>
                            <div class="form-group col-sm-6">
                                <label>Ende</label>
                                <input type="text" name="evtEnd" class="form-control col-xs-3" disabled/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Passwort</label>
